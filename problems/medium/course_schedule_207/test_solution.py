...
class TestSolution(BaseTestSolution):
    ...
    @pytest.mark.parametrize("method_name, num_courses, prerequisites, expected, timeout", [
        ('can_finish', 2, [[1, 0]], True, BaseTestSolution.DEFAULT_TIMEOUT),
        ('can_finish', 2, [[1, 0], [0, 1]], False, BaseTestSolution.DEFAULT_TIMEOUT),
        ('can_finish', 100,
         [[1, 0], [2, 0], [2, 1], [3, 1], [3, 2], [4, 2], [4, 3], [5, 3], [5, 4], [6, 4], [6, 5], [7, 5], [7, 6],
          ...
          [96, 95], [97, 95], [97, 96], [98, 96], [98, 97], [99, 97]], True, BaseTestSolution.DEFAULT_TIMEOUT),
    ])
    def test_can_finish(self, method_name, num_courses, prerequisites, expected, timeout):
        self._run_test(self.solution, method_name, (num_courses, prerequisites,), expected, timeout)
